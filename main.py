...
pathparser = subparser.add_parser('path',
                                  help='Compute the most probable path connecting two equilibrium states of a biomolecule')
...
rockparser.add_argument('-exag', metavar='', default=10.0, type=float,
                        help='The motion in exaggerated while rocking the structure such that the displacement from equilibrium is perceptible [default: 10]')
